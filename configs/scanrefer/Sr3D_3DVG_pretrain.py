...
param_dicts = [dict(keyword="backbone_net", lr=1e-3, weight_decay=0.0005)]
scheduler = dict(type="MultiStepLR", gamma=0.1, milestones=[0.5])

# dataset settings
dataset_type = "Joint3DDataset_sr3d"
