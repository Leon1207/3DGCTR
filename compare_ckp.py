...
# 加载两个检查点
checkpoint1 = torch.load('/userhome/lyd/Pointcept/exp/scanrefer/debug/model/model_last_6441.pth')
checkpoint2 = torch.load('/userhome/lyd/Pointcept/exp/scanrefer/debug/model/model_last_6634.pth')
